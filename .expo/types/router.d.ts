...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(home)/history` | `/history` | `/(home)/profile` | `/profile` | `/(home)/scanner` | `/scanner` | `/modal` | `/navigation/authStack` | `/navigation/` | `/navigation/userStack` | `/screens/login` | `/screens/questionnaire` | `/screens/register`;
  // prettier-ignore
